...
description: "Reads CLAUDE.md and .claude/rules/* for a project and evaluates quality via LLM-judgment: length, internal contradictions, ambiguities, placeholder content, progressive disclosure, sensitive file protection. Returns CONTEXT_REPORT JSON. Read-only."
