...
description: "Audits a project's automation and verification posture: test runner, formatter/linter PostToolUse hooks, PreToolUse dangerous-action blocks, verifier-agent separation, and whether registered project skills/hooks are actually invoked in recent sessions. Returns AUTOMATION_REPORT JSON."
